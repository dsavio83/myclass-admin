...
export const BelowAveragePage: React.FC<BelowAveragePageProps> = ({ lessonId, user, readOnly = false }) => {
    ...
    return (
        <div className="h-full flex flex-col bg-gray-50 dark:bg-gray-900">
            {/* Header / Tabs */}
            <div className="shrink-0 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm z-20 relative">
                    ...
                    <div className="flex items-center justify-between h-16">
                                    ...
                                    <button
                                        ...
                                        className={`
                                            ...
                                            ${isActive
                                                ...
                                                : 'text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-gray-200 border border-transparent'}
                                        `}
                                    >
                        ...
                        <div className="flex md:hidden">
                            <button
                                ...
                                className="p-2 rounded-md text-gray-500 hover:text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 focus:outline-none"
                            >
                                ...
                                {isMenuOpen ? (
                                    ...
                                    <div className="flex items-center gap-2 px-3 py-1.5 bg-gray-100 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-600">
                                        <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">{activeTabLabel}</span>
                ...
                {isMenuOpen && (
                    <div className="md:hidden border-t border-gray-200 dark:border-gray-700 animate-fade-in-down absolute w-full bg-white dark:bg-gray-800 shadow-lg">
                            ...
                            {tabs.map(tab => {
                                ...
                                return (
                                    <button
                                        ...
                                        `}
                                    >
                                        <div className={`p-2 rounded-lg ${isActive ? 'bg-white dark:bg-rose-900/40' : 'bg-gray-100 dark:bg-gray-700'}`}>
