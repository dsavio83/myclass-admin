...
import { TrashIcon, DownloadIcon, EyeIcon, UploadCloudIcon, ExpandIcon, SaveIcon, ChevronLeftIcon, ChevronRightIcon, CheckCircleIcon, LinkIcon } from '../icons/AdminIcons';
    ...
    return (
        <div className="w-full max-w-5xl mx-auto bg-white dark:bg-gray-800/80 backdrop-blur-md rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden min-h-[500px] flex flex-col md:flex-row animate-scale-in">
            ...
            <div className="w-full md:w-5/12 p-6 sm:p-8 bg-gray-50/50 dark:bg-gray-900/30 border-r border-gray-100 dark:border-gray-700 flex flex-col">
                <div className="mb-8">
                    <h3 className="text-xl font-bold text-gray-800 dark:text-white mb-2">Configure Slides</h3>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Set the title and choose your upload method for the new slides.</p>
                </div>

                <div className="space-y-6 flex-1">
                    <div>
                        <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Slide Title</label>
            ...
            <div className="w-full md:w-7/12 p-6 sm:p-10 flex flex-col justify-center items-center bg-white dark:bg-gray-800 relative group">
                <div className="w-full max-sm:max-w-xs w-full max-w-sm">
                    {activeTab === 'upload' && (
                        <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-300">
                            ...
                            >
                                <input id="slideFile" name="slideFile" type="file" className="absolute inset-0 opacity-0 cursor-pointer" onChange={handleFileChange} accept=".pdf" />
